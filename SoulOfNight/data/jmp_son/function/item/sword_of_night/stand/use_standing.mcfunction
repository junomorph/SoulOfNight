...
execute at @s if entity @s[scores={jmp_son.raisetime=5,jmp_son.ct.tp=1..}] run return run playsound minecraft:entity.arrow.hit_player player @s ~ ~ ~ 1 2
execute if entity @s[scores={jmp_son.raisetime=20,jmp_son.ct.tp=0}] run tag @s add jmp_son.stab_ready
execute at @s if entity @s[scores={jmp_son.raisetime=20,jmp_son.ct.tp=0}] run playsound minecraft:entity.arrow.hit_player player @s ~ ~ ~ 1 1.5