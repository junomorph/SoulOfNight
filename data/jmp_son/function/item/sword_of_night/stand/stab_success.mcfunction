...
execute if entity @s[distance=..3,tag=jmp_son.stabbing] positioned ~-0.25 ~-0.25 ~-0.25 as @n[dx=0.5,type=!#jmp_son:not_mob,type=!armor_stand,tag=!jmp_son.stab_ready] run return run function jmp_son:item/sword_of_night/stand/stabbed
