...
#ポータルの表示
execute as @e[tag=jmp_son.portal] at @s run function jmp_son:item/sword_of_night/portaldisplayer

#NoAIから復帰
execute as @e[tag=jmp_son.debuff] at @s run function jmp_son:item/sword_of_night/stun